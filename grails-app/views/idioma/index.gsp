		...
		<div id="list-idioma" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="code" title="${message(code: 'idioma.code.label', default: 'Code')}" />
				...
				<g:each in="${idiomaInstanceList}" status="i" var="idiomaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${idiomaInstance.id}">${fieldValue(bean: idiomaInstance, field: "nombre")}</g:link></td>
					
						<td>${fieldValue(bean: idiomaInstance, field: "code")}</td>
