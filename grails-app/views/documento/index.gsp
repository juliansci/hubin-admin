		...
		<div id="list-documento" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="extension" title="${message(code: 'documento.extension.label', default: 'Extension')}" />
				...
				<g:each in="${documentoInstanceList}" status="i" var="documentoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: documentoInstance, field: "extension")}</td>
