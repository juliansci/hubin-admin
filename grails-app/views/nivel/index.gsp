		...
		<div id="list-nivel" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="code" title="${message(code: 'nivel.code.label', default: 'Code')}" />
				...
				<g:each in="${nivelInstanceList}" status="i" var="nivelInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${nivelInstance.id}">${fieldValue(bean: nivelInstance, field: "nombre")}</g:link></td>
					
						<td>${fieldValue(bean: nivelInstance, field: "code")}</td>
