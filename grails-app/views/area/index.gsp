		...
		<div id="list-area" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombre" title="${message(code: 'area.nombre.label', default: 'Nombre')}" />
					
						<th><g:message code="area.entidad.label" default="Entidad" /></th>
				...
				<g:each in="${areaInstanceList}" status="i" var="areaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${areaInstance.id}">${fieldValue(bean: areaInstance, field: "nombre")}</g:link></td>
					
						<td>${fieldValue(bean: areaInstance, field: "entidad")}</td>
