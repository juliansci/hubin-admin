	...
	<body>
		...
		<div id="show-file" class="content scaffold-show" role="main">
			...
			<ol class="property-list file">
				...
				<g:if test="${fileInstance?.extension}">
				<li class="fieldcontain">
					<span id="extension-label" class="property-label"><g:message code="file.extension.label" default="Extension" /></span>
					
						<span class="property-value" aria-labelledby="extension-label"><g:fieldValue bean="${fileInstance}" field="extension"/></span>
